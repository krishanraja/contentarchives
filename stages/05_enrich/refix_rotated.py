...
stages/05_enrich/thumbnail.py did not honour EXIF orientation, and `convert("RGB")`
...
def main() -> None:
    ...
    if a.apply:
        ...
        # stagepath.script(), not a relative path: thumbnail.py moved from
        # engine/ into this stage, and a hardcoded "..\engine" would have kept
        # resolving to nothing while the run reported success (learning 34).
        spec = importlib.util.spec_from_file_location(
            "th", stagepath.script("thumbnail.py"))
